...
public class OutputWriter
{
    ...
    /**
     * Returns a reader that writes possibly renamed resource files to the
     * given resource copier.
     */
    private DataEntryReader renameResourceFiles(ClassPool       programClassPool,
                                                DataEntryReader resourceCopier)
    {
        ...
        return
            new NameFilter(configuration.adaptResourceFileNames,
                new DataEntryObfuscator(programClassPool, packagePrefixMap, resourceCopier),
                resourceCopier);
    }
