             ...
             MemberVisitor
{
    ...
    public static final int CLASS_INDEX       = InstructionSequenceMatcher.A;
    public static final int MEMBER_NAME_INDEX = InstructionSequenceMatcher.B;
    public static final int MEMBER_TYPE_INDEX = InstructionSequenceMatcher.C;
    ...
    {
        new ConstantInstruction(InstructionConstants.OP_LDC, CLASS_INDEX),
        new ConstantInstruction(InstructionConstants.OP_LDC, MEMBER_TYPE_INDEX),
        new ConstantInstruction(InstructionConstants.OP_LDC, MEMBER_NAME_INDEX),
        new ConstantInstruction(InstructionConstants.OP_INVOKESTATIC, 0),
    };
    ...
    public void visitAnyInstruction(Clazz clazz, Method method, CodeAttribute codeAttribute, int offset, Instruction instruction)
    {
        ...
        matchGetMember(clazz, method, codeAttribute, offset, instruction,
                       ...
                       getIntegerUpdaterMatcher, true, false, false,
        ...
        matchGetMember(clazz, method, codeAttribute, offset, instruction,
                       ...
                       getLongUpdaterMatcher, true, false, false,
        ...
        matchGetMember(clazz, method, codeAttribute, offset, instruction,
                       ...
                       getReferenceUpdaterMatcher, true, false, false,
                       null);
    }
                                                  ...
                                                  boolean isDeclared)
    {
        if (DEBUG)
        {
            System.out.println("DynamicMemberReferenceInitializer: ["+clazz.getName()+"] matched string ["+memberName+"]");
        }
        ...
        Member referencedMember =
            referencedMemberFinder.findMember(clazz,
                                              referencedClass,
                                              memberName,
                                              memberDescriptor,
                                              isField);
     ...
     * constructs with constants arguments. It then makes sure the class member
