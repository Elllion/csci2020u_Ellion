...
{
    protected final ConstantPoolEditor constantPoolEditor;

    protected final List<Instruction> instructions = new ArrayList<Instruction>(256);
    ...
    {
        this(new ProgramClass(0, 0, new Constant[256], 0, 0, 0),
             programClassPool,
             libraryClassPool);
    }
