...
implements   ClassVisitor
{
    ...
    private ProgramClass createUtilityClass(ProgramClass interfaceClazz)
    {
        ...
        ConstantPoolEditor constantPoolEditor =
            new ConstantPoolEditor(utilityClass);
                                     ...
                                     Set<String>  staticMethods)
    {
        ...
        for (String staticMethod : staticMethods)
        {
            ...
            // Need to create an InterfaceMethodRefConstant
            // as it is a static interface method.
            int originalInterfaceMethodRefIndex =
            ...
            Instruction[][] replacement = new Instruction[][]
                {
                    ____.invokestatic(originalInterfaceMethodRefIndex).__(),
