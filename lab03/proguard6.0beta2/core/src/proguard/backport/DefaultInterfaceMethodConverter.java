             ...
             AttributeVisitor
{
    ...
    {
        String originalMethodName = method.getName(interfaceClass);
        String methodDesc         = method.getDescriptor(interfaceClass);
        ...
        method.accept(interfaceClass,
            new MemberAdder(targetClass, memberRenamer, null));

        String targetMethodName =
            memberRenamer.transform(method.getName(interfaceClass));

        InstructionSequenceBuilder ____ =
            new InstructionSequenceBuilder();

        int originalMethodRefIndex =
            ____.getConstantPoolEditor()
                .addInterfaceMethodrefConstant(interfaceClass.getName(),
                                               originalMethodName,
                                               methodDesc,
                                               null,
                                               null);
        ...
        Instruction[][][] instructions  = new Instruction[][][]
            {
                ...
                {
                    ____.invokespecial(originalMethodRefIndex).__(),

                    ____.invokevirtual(targetClass.getName(),
                                       targetMethodName,
                                       methodDesc).__()
                }
            };
